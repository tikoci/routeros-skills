...
- **Prompt, echo, and output shape.** The prompt is `[user@identity] > ` (root) or
  `[user@identity] /path> ` (submenu), redrawn with CR + space-padding + CR (not
